              ...
              <div className='relative px-8'>
                ...
                <blockquote className='mt-8'>
                  <div className='relative text-lg font-medium text-white md:flex-grow'>
                    ...
                    'Exclusively crafted by IBM,  Backed by IBMs renowned reliability and efficiency in post-sales service, we stand as a beacon of trust for clients at the University of Leicester (UOL). 
                    Our services are tailored to empower students with the knowledge and tools necessary to excel in the dynamic field of logistics. IBM's support at UOL are dedicated to nurturing the next generation of industry leaders
                    </p>
                  </div>

                  <footer className='mt-4'>
                    <p className='text-base font-semibold text-gray-400'>
                    Bill Kelleher, CEO at IBM
                    </p>
                  </footer>
                </blockquote>
              </div>
          ...
          <div className='mt-10'>
            ...
            <div className='mt-10'>
              <a href='#' className='text-base font-medium text-yellow-500'>
                {' '}
                More about IBM<span aria-hidden='true'>&rarr;</span>{' '}
              </a>
            </div>
          </div>
        </div>
