      ...
      <div className='flex flex-wrap justify-center lg:justify-between items-center'>
        <div className='flex flex-col w-full lg:w-1/2 px-5'>
          ...
          <h3 className='text-lg'>
            are university-based community groups for students interested into solve local problems and enhance
            their technical knowledge. EASEUOL is a meld of adept team members
            ...
            the domains of Machine Learning, Web Development, and OTER SERVICES LIKE FOOD,ROOM CLEANING. The team believes in “Coming together is beginning,
